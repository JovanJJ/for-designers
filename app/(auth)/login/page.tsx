    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-50/50 p-4">
      <div className="w-full max-w-md bg-white border border-zinc-200 p-8 md:p-10 rounded-2xl shadow-sm animate-in fade-in zoom-in-95 duration-200">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-serif text-zinc-900 tracking-tight">Welcome Back</h1>
          <p className="text-sm text-zinc-500 mt-2">Sign in to your designer dashboard</p>
        </div>
        ...
        <form onSubmit={onCredentialsLogin} className="flex flex-col gap-6">
          <div>
